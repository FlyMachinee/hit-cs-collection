...
#include <iostream>
#include "../header/MyList/Stack.hpp"
#include <vector>
#include <string>
#include <fstream>
#include <cmath>
...
template <typename T>
void show_stack_in_graph(Stack<T> &st, char separator, int type, char elem, int boundary_len, const std::string& memo);
